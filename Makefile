...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name cloudflare-kubernetes-gateway-builder
	$(CONTAINER_TOOL) buildx use cloudflare-kubernetes-gateway-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm cloudflare-kubernetes-gateway-builder
	rm Dockerfile.cross
